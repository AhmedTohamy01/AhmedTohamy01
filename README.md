...
***My Coding Skills:***<br>
HTML | CSS | JavaScript | React | Redux | SASS | BootStrap | Ruby | Ruby on Rails | RSpec | SQL | Git | Github | Github Flow | VSCode | Code Linter | Firbase | Heroku | Github Pages | RESTful API | JSON | AJAX | JSX | Responsive Design | Mobile-First Design | Agile | Scrum.
